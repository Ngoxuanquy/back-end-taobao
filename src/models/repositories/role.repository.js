...
const createRole = async ({ name = 'shop', slug = 's00001', description = '', grants = [] }) => {
    // check role exists
    // nre role
...
const searchRoleListOfUser = async ({ userId = '', limit = 30, offset = 0, search = '' }) => {};

const getRoleListOfUser = async ({ userId = '' }) => {
    try {
        // get role of user
