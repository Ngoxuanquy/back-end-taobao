...
class ProductController {
    ...
    searchProducts = catchAsync(async (req, res) => {
        OK(res, 'Search product success', await ProductService.searchProducts(req.params));
    });

    findAllProducts = catchAsync(async (req, res) => {
        OK(res, 'find all product success', await ProductService.findAllProducts(req.params));
    });

    findProduct = catchAsync(async (req, res) => {
        OK(res, 'find product success', await ProductService.findOneProduct(req.params.product_id));
    });

    advancedSearch = catchAsync(async (req, res) => {
        OK(res, 'advanced search product success', await ProductService.advancedSearch(req.params.query));
    });
}
